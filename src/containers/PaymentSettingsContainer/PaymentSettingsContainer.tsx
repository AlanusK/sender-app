  ...
  return (
    <div className="payment-container-wrapper">
      ...
      <div className="payment-input-wrapper">
        <Form className="payment-form" layout="vertical" form={form}>
          <Form.Item
            label={<label style={{ color: "gray" }}>Stellar Address</label>}
          >
            <Input
          ...
          <Form.Item
            label={<label style={{ color: "gray" }}>Secret Key</label>}
          >
            <Input
              className="payment-form"
          ...
          <Form.Item
            label={<label style={{ color: "gray" }}>Default Currency</label>}
          >
            <Input
              className="payment-form"
              placeholder="TZS"
